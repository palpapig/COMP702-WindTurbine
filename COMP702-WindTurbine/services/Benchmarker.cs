        ...
        using (var tempScope = scopeFactory.CreateScope())
            {
                ...
                List<TurbineTelemetry> yearTelemetry = await tempDbService.GetTurbineDataYear(turbineId, benchmarkEndDate);
        ...
        using (var tempScope = scopeFactory.CreateScope())
            {
                ...
                //TODO get data from csv
                List<TurbineTelemetry> benchmarkTelemetry = await tempDbService.GetTurbineDataYear("BK-TEST-4", DateTime.Now);
